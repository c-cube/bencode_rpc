...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6e872442dd6d3e7435e1673bcd7b81db) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./tests/all.sh", []))];
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "bencode_rpc";
     ...
     oasis_version = "0.4.8";
     oasis_digest =
       Some ":\028\001\208\2483~\143\157\199\150n\196\238\255\003";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
