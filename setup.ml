...
(* OASIS_START *)
(* DO NOT EDIT (digest: dac13c2ecc1438625673ee6c9f845a17) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("bencode_rpc", OCamlbuildDocPlugin.doc_build ".")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("bencode_rpc", OCamlbuildDocPlugin.doc_clean ".")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          ...
          homepage = Some "https://github.com/c-cube/bencode_rpc";
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Bencode"; "RPC"; "Net_tcp"; "Lwt_queue"; "Signal"];
                      lib_pack = true;
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "documentation for Bencode-RPC";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      ...
                      src_repo_browser =
                        Some
                          "https://github.com/c-cube/bencode_rpc/tree/master/src";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\149\187\238\175\214F\223VY\144\167\163D\199<~";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
